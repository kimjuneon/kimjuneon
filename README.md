...
| Data & Events | Architecture | Reliability | Operations |
| :---: | :---: | :---: | :---: |
| 대량 데이터·이벤트 정합성 | Hexagonal·Port/Adapter | 테스트·재시도·복구 | 배포·관측성·운영 지표 |
...
| | |
| :---: | :---: |
| **[Today I Learned →](https://github.com/kimjuneon/TIL)** | 프로젝트에서 마주친 문제와 해결 과정을 재현 가능한 기록으로 정리합니다. |
| **[Velog →](https://velog.io/@juneon/posts)** | 선택지와 구현, 테스트 결과와 한계를 기술 글로 남깁니다. |
