...
Java와 Spring Boot를 중심으로 안정적인 서버와 API를 만듭니다.

읽기 쉬운 코드, 명확한 책임, 운영까지 이어지는 서비스를 중요하게 생각합니다.
...
- Java와 Spring Boot 기반의 백엔드 개발을 중심으로 경험을 쌓고 있습니다.
- REST API, 인증/인가, 데이터베이스와 이벤트 기반 처리에 관심이 많습니다.
- 테스트와 명확한 책임 분리를 통해 변경하기 쉬운 구조를 지향합니다.
- 아이디어를 실제 서비스로 만들고 배포 이후의 운영까지 확인합니다.
...
![Most Commit Language](./assets/most-commit-language.svg)
